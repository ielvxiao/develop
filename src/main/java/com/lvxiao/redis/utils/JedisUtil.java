...
import com.lvxiao.redis.RedisConnection;
...
public class JedisUtil {
    ...
    static {
        ...
        redisConnection.setIp("35.220.148.221");
        redisConnection.setPort(6379);
        redisConnection.setPwd("lvxiao123456");
        ...
        jedisPool = redisConnection.buildConnection();
    }
